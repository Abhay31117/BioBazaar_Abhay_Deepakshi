...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AnimatedbottombarLibraryAccessors laccForAnimatedbottombarLibraryAccessors = new AnimatedbottombarLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>library</b> with <b>nl.joery.inanimateness:library</b> coordinates and
    ...
    /**
     * Dependency provider for <b>materialsearchbar</b> with <b>com.github.mancj:MaterialSearchBar</b> coordinates and
     * with version reference <b>materialsearchbar</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getMaterialsearchbar() {
        return create("materialsearchbar");
    }
    ...
    /**
     * Group of libraries at <b>animatedbottombar</b>
     */
    public AnimatedbottombarLibraryAccessors getAnimatedbottombar() {
        return laccForAnimatedbottombarLibraryAccessors;
    }
    ...
    public static class AnimatedbottombarLibraryAccessors extends SubDependencyFactory {

        public AnimatedbottombarLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>library</b> with <b>nl.joery.animatedbottombar:library</b> coordinates and
         * with version reference <b>libraryVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLibrary() {
            return create("animatedbottombar.library");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>library</b> with value <b>1.0.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>libraryVersion</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>materialsearchbar</b> with value <b>0.8.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterialsearchbar() { return getVersion("materialsearchbar"); }
